...
import com.zr.praxisai.mapper.MockInterviewMapper;
import com.zr.praxisai.model.dto.mockinterview.MockInterviewAddRequest;
import com.zr.praxisai.model.dto.mockinterview.MockInterviewChatMessage;
...
import com.zr.praxisai.model.enums.MockInterviewEventEnum;
import com.zr.praxisai.model.enums.MockInterviewStatusEnum;
...
/**
 * 针对表【mock_interview(模拟面试)】的数据库操作Service实现
 */
@Service
public class MockInterviewServiceImpl extends ServiceImpl<MockInterviewMapper, MockInterview>
    ...
    private String handleChatStartEvent(MockInterview mockInterview) {
        ...
        ChatMessage assistantMessage = ChatMessage.builder().
                role(ChatMessageRole.ASSISTANT).content(answer).build();
        //加载结果到消息列表中
        messages.add(assistantMessage);

        // 将大模型消息记录转换为 消息记录表，并将其转换成json字符串存入数据库中
    ...
    private String handleChatMessageEvent(MockInterviewEventRequest mockInterviewEventRequest, MockInterview mockInterview) {
        ...
        final ChatMessage chatUserMessage = ChatMessage.builder()
        ...
        ChatMessage chatAssistantMessage = ChatMessage.builder().
                role(ChatMessageRole.ASSISTANT).content(chatAnswer).build();
    ...
    private String handleChatEndEvent(MockInterview mockInterview) {
        ...
        final ChatMessage endUserMessage = ChatMessage.builder().
                role(ChatMessageRole.USER).content(endUserPrompt).build();
        ...
        ChatMessage endAssistantMessage = ChatMessage.builder().
                role(ChatMessageRole.ASSISTANT).content(endAnswer).build();
    ...
    //消息记录对象转换 MockInterviewChatMessage
