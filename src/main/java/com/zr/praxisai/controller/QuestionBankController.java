...
import com.zr.praxisai.model.dto.questionBank.QuestionBankAddRequest;
import com.zr.praxisai.model.dto.questionBank.QuestionBankEditRequest;
import com.zr.praxisai.model.dto.questionBank.QuestionBankQueryRequest;
import com.zr.praxisai.model.dto.questionBank.QuestionBankUpdateRequest;
import com.zr.praxisai.model.entity.Question;
import com.zr.praxisai.model.entity.QuestionBank;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        // 判断是否是是热 key，并且会将 key 上报到探测集群进行数量计算。
        //通常用于判断只需要判断 key 是否过热、不需要缓存 value 的场景，如接口访问频率等。
        if (JdHotKeyStore.isHotKey(key)) {
            // 如果是热 key
            // 则从本地缓存中获取该key的value缓存值
